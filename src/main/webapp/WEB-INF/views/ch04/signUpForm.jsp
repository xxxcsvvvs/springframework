            ...
            <div class="d-flex row">
               ...
               <div class="col-md-8">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <form class="m-2" method="post" action="signUp"> <!-- get 방식으로 하면 input값이 넘어옴 -->
                           ...
                           <div class="form-group mb-2">
                               ...
                               <input type="text" class="form-control" id="mid" name="mid" value="${ch04SignUpForm.mid}">
                  				<div><form:errors path="ch04SignUpForm.mid"/></div>
                           ...
                           <div class="form-group mb-2">
                               ...
                               <div><form:errors path="ch04SignUpForm.mphoneNumber"/></div>
                           </div>
